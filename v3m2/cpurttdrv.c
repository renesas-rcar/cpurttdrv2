...
static void __iomem *g_RegBaseAddrTable[DRV_RTTKER_HIERARCHY_MAX] = {
    NULL,  /* Video Codec Hierarchy(IMR01) */
    NULL,  /* Video Codec Hierarchy(IMR23) */
    NULL,  /* Image Recognition Hierarchy (IMP core0, IMP core1) */
    NULL,  /* Image Recognition Hierarchy (IMP core2, IMP core3) */
    NULL,  /* Image Recognition Hierarchy (DMAC, PSC) */
    NULL,  /* Image Recognition Hierarchy (CNN) */
...
static const phys_addr_t drvRTT_PhyRegAddr[DRV_RTTKER_HIERARCHY_MAX] = {
    DRV_RTTKER_IM0_RTTEX,
    DRV_RTTKER_IM1_RTTEX,
...
static const uint32_t drvCPURTTKER_SgirData[3U] = {
...
static void FbistInterruptHandler(int irq, struct uio_info *uio_info)
{
    ...
    static const drvCPURTT_FbistHdr_t FbisthdrInfo[DRV_RTTKER_HIERARCHY_MAX] = {
        {DRV_RTTKER_HIERARCHY_OTHER, DRV_RTTKER_HIERARCHY_IM0,  DRV_RTTKER_IM0_RTTFINISH1_BIT,   DRV_RTTKER_IM0_RTTEX },
        {DRV_RTTKER_HIERARCHY_OTHER, DRV_RTTKER_HIERARCHY_IM1,  DRV_RTTKER_IM1_RTTFINISH1_BIT,   DRV_RTTKER_IM1_RTTEX },
        {DRV_RTTKER_HIERARCHY_OTHER, DRV_RTTKER_HIERARCHY_IMP0, DRV_RTTKER_IMP0_RTTFINISH1_BIT,  DRV_RTTKER_IMP0_RTTEX},
        {DRV_RTTKER_HIERARCHY_OTHER, DRV_RTTKER_HIERARCHY_IMP1, DRV_RTTKER_IMP1_RTTFINISH1_BIT,  DRV_RTTKER_IMP1_RTTEX},
        {DRV_RTTKER_HIERARCHY_OTHER, DRV_RTTKER_HIERARCHY_IMP2, DRV_RTTKER_IMP2_RTTFINISH1_BIT,  DRV_RTTKER_IMP2_RTTEX},
        {DRV_RTTKER_HIERARCHY_OTHER, DRV_RTTKER_HIERARCHY_IMP3, DRV_RTTKER_IMP3_RTTFINISH1_BIT,  DRV_RTTKER_IMP3_RTTEX},
        {DRV_RTTKER_HIERARCHY_OTHER, DRV_RTTKER_HIERARCHY_OCV0, DRV_RTTKER_OCV0_RTTFINISH1_BIT,  DRV_RTTKER_OCV0_RTTEX},
        {DRV_RTTKER_HIERARCHY_OTHER, DRV_RTTKER_HIERARCHY_OCV1, DRV_RTTKER_OCV1_RTTFINISH1_BIT,  DRV_RTTKER_OCV1_RTTEX},
...
static long drvCPURTT_UDF_HWAExecute(uint32_t aHierarchy, uint32_t aRttex)
{
    ...
    /* check hierarhcy */
    if ( (aHierarchy>=(uint32_t)DRV_RTTKER_HIERARCHY_IM0) && (aHierarchy<=(uint32_t)DRV_RTTKER_HIERARCHY_OCV1) )
    {
